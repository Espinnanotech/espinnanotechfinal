...
export function Footer() {
  ...
  return (
    <footer className="bg-black text-white px-4 md:px-6 py-8 relative">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <button 
            ...
            className="px-6 py-3 bg-red-600 text-white rounded-full hover:bg-red-700 transition-colors text-lg font-semibold text-center"
          >
            Get Started Today
          </button>             
